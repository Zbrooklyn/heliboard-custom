...
object KeyCode {
    ...
    const val REWRITE =                  -10052
    const val TOGGLE_STT_MODE =          -10053
    const val TOGGLE_RESIZE_KEYBOARD =   -10054
    const val REWRITE_ALL_STYLES =      -10055
    const val QUICK_TEXT =              -10056
    ...
    fun Int.checkAndConvertCode(): Int = if (this > 0) this else when (this) {
        ...
        SEND_INTENT_THREE, EMOJI_SEARCH, INLINE_EMOJI_SEARCH_DONE, META_LOCK, REWRITE,
        TOGGLE_ACTIONS_OVERFLOW, TOGGLE_STT_MODE, TOGGLE_RESIZE_KEYBOARD, REWRITE_ALL_STYLES,
        QUICK_TEXT
        -> this
